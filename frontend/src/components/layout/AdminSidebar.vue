...
<Transition name="sidebar">
   <div class="admin-overlay" v-if="open" @click.self="$emit('close')">
      <div class="admin-sidebar">
         <p class="admin-body-text">Sidebar</p>
         <div class="admin-sidebar__list">
            <ul>
               <li @click="$emit('close')"> 
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960"><path d="m177-120-57-57 184-183H200v-80h240v240h-80v-104L177-120Zm343-400v-240h80v104l183-184 57 57-184 183h104v80H520Z"/></svg> 
                  <span class="admin-body-text">Hide sidebar</span>
               </li>
               <li @click="goTo('/admin')">
                  ...
                  <span class="admin-body-text">Admin Dashboard</span>
               </li>
               <li  @click="goTo('/admin/all')">
                  ...
                  <span class="admin-body-text">Products list</span>
               </li>
               <li  @click="goTo('/admin/users')">
                  ...
                  <span class="admin-body-text">Users list</span>
               </li>
               <li  @click="goTo('/admin/add')"> 
                  ...
                  <span class="admin-body-text">Create new product</span>
               </li>      
               <li  @click="goTo('/admin')">
                  ...
                  <span class="admin-body-text">Tasks List</span>
               </li>
               <li  @click="goTo('/')">
