<template>
  <div class="cart__item">
    ...
    <div class="cart__counter">
      <button class="delete" @click="user.decrementQuantity(props.colorKey)"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M200-440v-80h560v80H200Z"/></svg></button>
      <p class="body-text"> {{quantity}} </p>
      <button class="edit"@click="user.incrementQuantity(props.colorKey)"><svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M440-440H200v-80h240v-240h80v240h240v80H520v240h-80v-240Z"/></svg></button>
    </div>
